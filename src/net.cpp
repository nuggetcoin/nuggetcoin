...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nuggetcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"node1.Nuggetcoin.info", "node1.Nuggetcoin.info"},
    {"node2.Nuggetcoin.info", "node2.Nuggetcoin.info"},
    {"node3.Nuggetcoin.info", "node3.Nuggetcoin.info"},
    {"node4.Nuggetcoin.info", "node4.Nuggetcoin.info"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nuggetcoin is probably already running."), addrBind.ToString().c_str());
        else
